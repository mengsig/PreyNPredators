...
pub const DEFAULT_ENERGY_LOSS: f32 = SPLIT_ADD / 8;
...
pub const VISION_LENGTH: f32 = 750;
...
// Plotting stuff
pub const PLOT_WINDOW_HEIGHT: u16 = 1500;
pub const PLOT_WINDOW_WIDTH: u16 = 800;
pub const PLOT_MAX_POINTS: i32 = @intCast(AGENTNO);
pub const GRID_SIZE: i32 = 1500;
